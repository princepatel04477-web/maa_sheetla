...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 sm:h-20 bg-warp/90 backdrop-blur-md border-b border-hairline shadow-xs">
      <div className="max-w-7xl mx-auto h-full px-4 sm:px-8 lg:px-12 flex items-center justify-between">
        {/* Logo Only */}
        <Link href="/" className="flex items-center group shrink-0" aria-label="Maa Sheetla Agency Home">
