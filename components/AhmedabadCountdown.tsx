      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 relative z-10">
        ...
        <div className="w-full lg:w-auto flex flex-col sm:flex-row lg:flex-col items-center lg:items-end justify-center gap-3.5 sm:gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-2.5 w-full sm:w-auto">
            <Link
              href="/partner"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-kumkum hover:bg-kumkum-deep text-white font-mono text-xs tracking-wider uppercase rounded-xs transition-all shadow-agency-card w-full sm:w-auto whitespace-nowrap min-h-[44px] font-medium"
            >
              <span>Register Now — Open Trade Query</span>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-3.5 bg-selvedge-light hover:bg-selvedge border border-hairline hover:border-marigold text-khadi font-mono text-xs tracking-wider uppercase rounded-xs transition-all w-full sm:w-auto whitespace-nowrap min-h-[44px]"
            >
